        ...
        <div class="w-3/5 space-y-5">
            <x-card shadow='false'>
                ...
                <div class="px-8 mt-3">
                    ...
                    <x-select wire:model.live="ekspedition_id" label='Ekspedisi' placeholder="Pilih ekspedisi"
            ...
            <x-card shadow='false'>
                <div class="flex justify-between gap-5">
                    ...
                    @if ($payment_status == 'Cicil')
                        <x-input type="number" wire:model='amount' label="Dp" placeholder="Jumlah DP" />
                    @elseif($payment_status == 'Lunas')
                        <x-input type="number" wire:model='amount' label="Jumlah bayar" placeholder="Jumlah bayar" />
                    @endif
                </div>
            </x-card>
