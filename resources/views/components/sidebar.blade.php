<aside id="logo-sidebar"
        class="absolute top-0 left-0 z-40 w-64 h-screen pt-10 transition-all -translate-x-full border-r border-gray-200 bg-gray-50 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
