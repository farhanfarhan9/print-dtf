                        ...
                        <ul class="py-2 ml-3 space-y-2" :class="{ 'hidden': !dropdownExport }">
                            <li>
                                <a href="{{ route('export-customer.index') }}"
                                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                    :class="{ 'justify-center': !sidebarOpen }">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                    ...
                                    <span class="ms-3" :class="{ 'hidden': !sidebarOpen }">Data Berdasarkan Customer</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('export-product.index') }}"
                                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                                    :class="{ 'justify-center': !sidebarOpen }">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                    ...
                                    <span class="ms-3" :class="{ 'hidden': !sidebarOpen }">Data Berdasarkan Product</span>
                                </a>
                            </li>
                        </ul>
                    @endif
