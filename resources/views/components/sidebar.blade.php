<aside id="logo-sidebar"
    class="absolute top-0 left-0 z-40 w-64 h-screen pt-5 transition-all -translate-x-full border-r border-gray-200 bg-gray-50 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <div class="flex items-center gap-2 pb-5" :class="{ 'justify-center': !sidebarOpen }">
            ...
            <div @click="sidebarOpen = !sidebarOpen" class="object-scale-down p-1 text-gray-500 rounded-lg hover:cursor-pointer hover:text-gray-700 hover:bg-gray-100" >
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    :class="{ 'justify-center gap-2': !sidebarOpen }" aria-controls="dropdown-example"
                    ...
                    <span class="flex-1 text-left ms-3 rtl:text-right whitespace-nowrap"
                        :class="{ 'hidden': !sidebarOpen }">E-commerce</span>
