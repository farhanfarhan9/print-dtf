...
<body class="antialiased" x-data="{ sidebarOpen: true }">
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-all -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" :class="{ '-ml-36': !sidebarOpen }"
        aria-label="Sidebar">
    ...
    <div class="p-4 transition-all sm:ml-64" :class="{ 'sm:ml-36!important': !sidebarOpen }">
